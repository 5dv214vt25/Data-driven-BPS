...
def test_resource_model_optimizer(entry_point, test_data):
    ...
    assert isinstance(optimizer.best_bps_model.resource_model, ResourceModel)
    ...
    assert isinstance(optimizer.best_bps_model.resource_model.resource_profiles[0], ResourceProfile)
    ...
    assert isinstance(optimizer.best_bps_model.resource_model.resource_calendars[0], (RCalendar, FuzzyResourceCalendar))
    ...
    assert isinstance(
        optimizer.best_bps_model.resource_model.activity_resource_distributions[0], ActivityResourceDistribution
    )
