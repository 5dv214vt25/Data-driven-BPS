...
from simod.control_flow.discovery import add_bpmn_diagram_to_model
...
from simod.utilities import get_process_model_path
...
def _export_runtimes(file_path: Path, runtimes: RuntimeMeter):
    with open(file_path, "w") as file:
        json.dump(
            runtimes.runtimes
            | {
                "explanation": f"Add '{RuntimeMeter.PREPROCESSING}' with '{RuntimeMeter.TOTAL}' "
