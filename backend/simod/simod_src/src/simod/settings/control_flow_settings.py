...
class ControlFlowSettings(BaseModel):
    ...
    gateway_probabilities : Union[:class:`GatewayProbabilitiesDiscoveryMethod`
    , List[:class:`GatewayProbabilitiesDiscoveryMethod`]]
    ...
    gateway_probabilities: Union[GatewayProbabilitiesDiscoveryMethod, List[GatewayProbabilitiesDiscoveryMethod]] = (
