...
def store_preprocessed_data(df_train, df_test, df_val, data_dir):
    ...
    df_train_without_end_activity = df_train_without_end_activity[
        df_train_without_end_activity["activity_name"] != "zzz_end"
    ]
    ...
    if df_test is not None:
        ...
        df_test_without_end_activity = df_test_without_end_activity[
            df_test_without_end_activity["activity_name"] != "zzz_end"
        ]
...
def store_simulated_log(data_dir, simulated_log, i):
